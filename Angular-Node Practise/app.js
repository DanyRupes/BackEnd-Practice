...
app.post('/findOneAndUpdate', function (req, res) {
 ...
 app.post('/upserted', function (req, res) {
     dataBase.userAccount.update({firstName : req.body.firstName},{$set :{place:req.body.place}}, function(err, raw){
        console.log(raw)    
        console.log(err)
    })
...
app.post('/unSet', function (req, res) {
    dataBase.userAccount.update({firstName : req.body.firstName},{$unset:{place : undefined}}, function(err, data){
        console.log("Success")
    })
    res.send("unSetted")
  })
...
app.post('/inserted', function (req, res) {
    // new 
     dataBase.userAccount({firstName: req.body.firstName, place: req.body.place}).save()
    res.send("insertted")
  })
